...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://codeberg.org/Delphi-Books/DelphiBooks-WebSite).
...
Any changes to templates must be the subject of [a ticket](https://codeberg.org/Delphi-Books/DelphiBooks-WebSite/issues) and be approved in advance. Otherwise your PULL REQUEST will be rejected.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://codeberg.org/Delphi-Books/DelphiBooks-WebSite) and [open a new issue](https://codeberg.org/Delphi-Books/DelphiBooks-WebSite/issues).
